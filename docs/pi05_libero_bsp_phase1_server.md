...
run_phase1_eval bsp 20000
run_phase1_eval baseline 30000
run_phase1_eval bsp 30000
```
...
run_phase1_eval_host bsp 20000
run_phase1_eval_host baseline 30000
run_phase1_eval_host bsp 30000
```
...
PYTHONPATH="$BSP_REPO_DIR/packages/openpi-client/src" \
  ...
  "$EVAL_BASE/bsp-step-20000" \
  "$EVAL_BASE/baseline-step-30000" \
  "$EVAL_BASE/bsp-step-30000" \
